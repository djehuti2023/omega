...
def env_reset(instance_id):
    """
    Réinitialiser l'état de l'environnement et renvoyer une premiere
    observation.

    Parametres:
        - instance_id: un identifiant court (tel que '3c657dbc')
         pour l'instance d'environnement
    Retourne:
        - observation : l'observation initiale de l'espace
    """
